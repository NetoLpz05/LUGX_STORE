<%-- 
    Document   : Detalles-MK1
    Created on : 18 nov 2025, 7:33:48 p.m.
    Author     : Usuario
--%>
...
<html>
    ...
    <title>Lugx Gaming - Mortal Kombat 1</title>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <span class="breadcrumb"><a href="inicio.jsp">Inicio</a>  >  <a href="shop.jsp">Tienda</a>  >  Mortal Kombat 1</span>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image">
            <img src="assets/images/MK1.webp" alt="">
          </div>
        </div>
        <div class="col-lg-6 align-self-center">
          <h4 style="font-size: medium;">Warner Bros. Games / <a href="#">NetherRealm Studios</a></h4>
          ...
          <ul>
            <li><span>Game ID:</span> MK1</li>
            <li><span>Género:</span> <a href="#">Peleas</a>, <a href="#">Singleplayer</a></li>
            <li><span>Multi-tags:</span> <a href="#">Pelea</a>, <a href="#">MK</a>, <a href="#">Mortal Kombat</a></li>
          </ul>
          <img src="assets/images/MK1Banner.jpg" alt="" style="width: 100%; margin-top: 20px; border-radius: 10px; height: auto;">
        </div>
        <div class="col-lg-12">
          <div class="sep"></div>
        </div>
