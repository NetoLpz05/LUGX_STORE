...
<head>
    ...
    <title><%= juego.getNombre() %> | LUGX Gaming</title> 
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <span class="breadcrumb"><a href="index.jsp">Inicio</a>  >  <a href="shop.jsp">Tienda</a>  >  Detalles</span>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 align-self-center">
          ...
          <form action="agregarproducto" method="POST">
            ...
            <input type="number" name="cantidad" class="form-control" value="1" min="1" style="width: 80px; display: inline-block; margin-right: 10px;">
