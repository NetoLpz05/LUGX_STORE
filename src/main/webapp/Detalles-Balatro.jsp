<%-- 
    Document   : Detalles-Balatro
    Created on : 18 nov 2025, 7:36:18 p.m.
    Author     : Usuario
--%>
...
<html>
    ...
    <title>Lugx Gaming - Balatro</title>
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <h3>Balatro</h3>
          <span class="breadcrumb"><a href="inicio.jsp">Inicio</a>  >  <a href="shop2.jsp">Tienda</a>  >  Balatro</span>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image">
            <img src="assets/images/balatro.jpg" alt="">
          </div>
        </div>
        <div class="col-lg-6 align-self-center">
          <h4 style="font-size: medium;">PLaystack / <a href="#">LocalThunk</a></h4>
          <h4>Balatro</h4>
          <span class="price">$20</span>
          <p>balatro balatrez esta jugando balatro</p>
          <form id="qty" action="#">
            <input type="qty" class="form-control" id="1" aria-describedby="quantity" placeholder="1">
            <button type="submit"><i class="fa fa-shopping-bag"></i> Añadir al carrito</button>
          </form>
          <ul>
            <li><span>Game ID:</span> Btro</li>
            <li><span>Género:</span> <a href="#">Roguelike</a>, <a href="#">Indie</a></li>
            <li><span>Multi-tags:</span> <a href="#">Poker</a>, <a href="#">Roguelike</a>, <a href="#">Indie</a></li>
          </ul>
          <img src="assets/images/balatro3.webp" alt="" style="width: 100%; margin-top: 20px; border-radius: 10px; height: auto;">
        </div>
        <div class="col-lg-12">
          <div class="sep"></div>
        </div>
            ...
            <div class="row">
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                  <p>Descripción larga del juego</p>
                </div>
              </div>
            </div>
          </div>
