...
<html lang="es">
  ...
  <head>
    ...
    <style>
        ...
        .custom-table tbody tr td:first-child { border-left: 1px solid #f9f9f9; border-top-left-radius: 15px; border-bottom-left-radius: 15px; }
        .custom-table tbody tr td:last-child { border-right: 1px solid #f9f9f9; border-top-right-radius: 15px; border-bottom-right-radius: 15px; }
        ...
        .btn-remove {
            ...
            background-color: #ffe5e7; color: #ee626b;
            border-radius: 50%;
            display: flex; align-items: center; justify-content: center;
            text-decoration: none; font-weight: bold; transition: 0.3s;
        }
        .btn-remove:hover { background-color: #ee626b; color: white; }
        ...
        .total-price { font-size: 32px; font-weight: 800; color: #0071f8; display: block; margin: 10px 0; }
        ...
        .btn-pagar { background-color: #ee626b; color: white; }
        .btn-pagar:hover { background-color: #d4535b; color: white; transform: translateY(-2px); }
        
        .btn-seguir { background-color: #333; color: white; font-size: 13px; }
        .btn-seguir:hover { background-color: #555; color: white; }

        .empty-cart { padding: 60px; text-align: center; color: #999; }
        .empty-cart i { font-size: 50px; margin-bottom: 20px; color: #ddd; }
    </style>
  </head>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
            ...
            <span class="breadcrumb"><a href="inicio.jsp">Inicio</a>  >  <a href="shop.jsp">Tienda</a>  >  Carrito</span>
        </div>
      </div>
    </div>
  </div>
