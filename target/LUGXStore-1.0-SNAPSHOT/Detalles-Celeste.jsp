<%-- 
    Document   : Detalles-Celeste
    Created on : 18 nov 2025, 7:35:09 p.m.
    Author     : Usuario
--%>
...
<html>
    ...
    <title>Lugx Gaming - Celeste</title>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image">
            <img src="assets/images/CelesteShop.jpg" alt="">
          </div>
        </div>
        <div class="col-lg-6 align-self-center">
          <h4 style="font-size: medium;">Maddy Makes Games / <a href="#">Maddy Thorson</a> y <a href="#">Noel Berry</a></h4>
          <h4>Celeste</h4>
          <span class="price">$15</span>
          <p>celeste descripcion</p>
          <form id="qty" action="#">
            <input type="qty" class="form-control" id="1" aria-describedby="quantity" placeholder="1">
            <button type="submit"><i class="fa fa-shopping-bag"></i> Añadir al carrito</button>
          </form>
          <ul>
            <li><span>Game ID:</span> Cste</li>
            <li><span>Género:</span> <a href="#">Plataformas</a>, <a href="#">Indie</a></li>
          </ul>
          <img src="assets/images/CelesteBanner.webp" alt="" style="width: 100%; margin-top: 20px; border-radius: 10px; height: auto;">
        </div>
        <div class="col-lg-12">
          <div class="sep"></div>
        </div>
